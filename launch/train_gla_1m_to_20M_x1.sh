...
#         2>&1 | tee /mnt/zehao/output_ori_7B_2M_2.log
...
#         2>&1 | tee /mnt/zehao/output_ori_7B_4M.log
...
#         --master_addr=127.0.0.1 \
#         --master_port=29500 \
#         ./main/train.py config=./main/configs/act_fsdp2_sp4/gla_7B_6M.yaml \
#         2>&1 | tee /mnt/zehao/output_ori_7B_6M.log
...
#         2>&1 | tee /mnt/zehao/output_ori_7B_8M.log
...
#         2>&1 | tee /mnt/zehao/output_ori_7B_16M.log
...
#         2>&1 | tee /mnt/zehao/output_ori_7B_32M.log
...
torchrun --nproc_per_node=8 \
        ...
        --master_addr=127.0.0.1 \
        --master_port=29501 \
        ./main/train.py config=./main/configs/act_fsdp2_sp4/gla_7B_4B.yaml \
        2>&1 | tee /mnt/zehao/output_freelong_7B_4B.log