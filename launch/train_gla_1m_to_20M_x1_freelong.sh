...
torchrun --nproc_per_node=8 \
        ...
        --master_addr=127.0.0.1 \
        --master_port=29501 \
        ./main/train.py config=./main/configs/act_fsdp2_sp4/gla_7B_256k.yaml \
        2>&1 | tee /mnt/zehao/output_freelong_7B_256k.log
torchrun --nproc_per_node=8 \
        --nnodes=1 \
        --node_rank=0 \
        --master_addr=127.0.0.1 \
...
torchrun --nproc_per_node=8 \
        ...
        --master_addr=127.0.0.1 \
        --master_port=29501 \
        ./main/train.py config=./main/configs/act_fsdp2_sp4/gla_7B_768k.yaml \
        2>&1 | tee /mnt/zehao/output_freelong_7B_768k.log
# torchrun --nproc_per_node=8 \
#         --nnodes=1 \
#         --node_rank=0 \
#         --master_addr=127.0.0.1 \
...
#         --master_addr=127.0.0.1 \
#         --master_port=29500 \
#         ./main/train.py config=./main/configs/act_fsdp2_sp4/gla_7B_32M.yaml \
#         2>&1 | tee /mnt/zehao/output_freelong_7B_32M.log
# torchrun --nproc_per_node=8 \
#         --nnodes=1 \
#         --node_rank=0 \
#         --master_addr=127.0.0.1 \
#         --master_port=29501 \
#         ./main/train.py config=./main/configs/act_fsdp2_sp4/gla_7B_64M.yaml \
#         2>&1 | tee /mnt/zehao/output_freelong_7B_64M.log
# torchrun --nproc_per_node=8 \
#         --nnodes=1 \
#         --node_rank=0 \
#         --master_addr=127.0.0.1 \
#         --master_port=29500 \
#         ./main/train.py config=./main/configs/act_fsdp2_sp4/gla_7B_1B.yaml \
#         2>&1 | tee /mnt/zehao/output_freelong_7B_1B.log
# torchrun --nproc_per_node=8 \
#         --nnodes=1 \
#         --node_rank=0 \
#         --master_addr=127.0.0.1 \
#         --master_port=29500 \
#         ./main/train.py config=./main/configs/act_fsdp2_sp4/gla_7B_2B.yaml \
#         2>&1 | tee /mnt/zehao/output_freelong_7B_2B.log