...
#         --nnodes=1 \
#         --node_rank=0 \
#         --master_addr=10.60.35.33 \
#         --master_port=29501 \
#         ./main/train_lru.py config=./main/model_config/gru/gru.yaml\
#         2>&1 | tee /mnt/zehao/output_gru.log
...
BASE_CONFIG=/mnt/zehao/ULTra/main/model_config/gru/gru_bf16.yaml
TMP_CONFIG_DIR=/mnt/zehao/ULTra/main/model_config/tmp_configs_bf16
LOG_DIR=/mnt/zehao/ULTra/main/model_log/log
CKPT_ROOT=/mnt/zehao/ULTra/main/model_ckpt/ckpt_bf16
...
while [ "$seq_len" -le "$max_seq_len" ]; do
    ...
    dump_dir="${CKPT_ROOT}/gru-freelong8k-40M-${seq_tag}"
    run_name="gru-freelong128k-bf16-40M-${seq_tag}"
